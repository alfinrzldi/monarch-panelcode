...
const offences = {
  A: [
    ...
    { name: "A07 - Mengemudi Melawan Arus", fine: 1500, time: 8, impound: 1 },
    {
  ...
  B: [
    ...
    { name: "B02 - Meludah Sembarangan", fine: 2000, time: 20, impound: 0 },
    {
    ...
    { name: "B06 - Berkelahi ditempat umum", fine: 800, time: 6, impound: 0 },
    {
    ...
    { name: "B08 - Gangguan Ketertiban Umum", fine: 800, time: 6, impound: 0 },
    { name: "B09 - Pencurian", fine: 1500, time: 18, impound: 0 },
    { name: "B10 - Vandalisme", fine: 1200, time: 12, impound: 0 },
    ...
    {
      name: "B14 - Memberikan laporan atau informasi palsu kepada petugas",
      fine: 900,
      time: 6,
      impound: 0,
    },
    ...
    {
      name: "B16 - Memperjualbelikan hewan yang dilindungi (hiu & penyu)",
      fine: 900,
      time: 6,
      impound: 0,
    },
    ...
    {
      name: "B18 - Ikut serta dalam kerusuhan yang menyebabkan kerugian",
      fine: 900,
      time: 6,
      impound: 0,
    },
  ...
  D: [
    ...
    {
      name: "D01 - Terlibat dalam pembuatan narkotika",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D01 - Menjual atau mendistribusikan narkotika",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D01 - Membawa Kanabis [1-10 pcs]",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D02 - Membawa Kanabis [11-25 pcs]",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D03 - Membawa Kanabis [ >25 pcs]",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D04 - Membawa Marijuana [1-10 pcs]",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D05 - Membawa Marijuana [11-25 pcs]",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D06 - Membawa Marijuana [ >25 pcs]",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D07 - Membawa Joint []",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D08 - Membawa Joint []",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "D09 - Membawa Joint []",
      fine: 15000,
      time: 120,
      impound: 0,
    },
  ...
  E: [
    ...
    {
      name: "E02 - Kepemilikan senjata api tanpa lisensi",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    ...
    {
      name: "E04 - Memperjualbelikan senjata api ilegal",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "E04 - Merakit senjata api ilegal",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "E05 - Penodongan senjata ke suatu individu / kelompok",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "E06 - Penembakan senjata ke suatu individu / kelompok",
      fine: 15000,
      time: 120,
      impound: 0,
    },
    {
      name: "E07 - Penyelundupan senjata",
      fine: 15000,
      time: 120,
      impound: 0,
    },
